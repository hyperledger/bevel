...
class ArtifactregistryProjectsLocationsRepositoriesFilesListRequest(_messages.Message):
  ...
  Fields:
    filter: An expression for filtering the results of the request. Filter
      ...
      central1/repositories/repo1/files/a/b/*"` --> Files with an   ID
      starting with "a/b/".   * `owner="projects/p1/locations/us-
      central1/repositories/repo1/packages/pkg1/versions/1.0"` -->   Files
      owned by the version `1.0` in package `pkg1`.
