...
service.
  ...
  class ProjectsLocationsCorpuraOperationsService(base_api.BaseApiService):
    ...
    _NAME = 'projects_locations_corpura_operations'

    def __init__(self, client):
      super(VideointelligenceV1.ProjectsLocationsCorpuraOperationsService, self).__init__(client)
      self._upload_configs = {
          }
...
service.
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/corpura/{corpuraId}/operations/{operationsId}',
        http_method='GET',
        method_id='videointelligence.projects.locations.corpura.operations.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='VideointelligenceProjectsLocationsCorpuraOperationsGetRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )

  class ProjectsLocationsCorpuraService(base_api.BaseApiService):
    """Service class for the projects_locations_corpura resource."""

    _NAME = 'projects_locations_corpura'

    def __init__(self, client):
      super(VideointelligenceV1.ProjectsLocationsCorpuraService, self).__init__(client)
      self._upload_configs = {
          }
