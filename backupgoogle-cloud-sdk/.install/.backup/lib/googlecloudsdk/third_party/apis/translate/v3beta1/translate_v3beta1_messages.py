...
class GlossaryInputConfig(_messages.Message):
  ...
  Fields:
    gcsSource: Required. Google Cloud Storage location of glossary data. File
      ...
      languages. The format is defined for Google Translation   Toolkit and
      documented in [Use a   glossary](https://support.google.com/translatorto
      olkit/answer/6306379?hl=en).
  """
