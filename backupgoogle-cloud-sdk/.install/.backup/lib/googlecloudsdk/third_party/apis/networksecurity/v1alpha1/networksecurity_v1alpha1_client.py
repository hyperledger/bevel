...
class NetworksecurityV1alpha1(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.projects_locations_authentication = self.ProjectsLocationsAuthenticationService(self)
  ...
  class ProjectsLocationsAuthenticationService(base_api.BaseApiService):
    """Service class for the projects_locations_authentication resource."""

    _NAME = 'projects_locations_authentication'

    def __init__(self, client):
      super(NetworksecurityV1alpha1.ProjectsLocationsAuthenticationService, self).__init__(client)
      self._upload_configs = {
          }

    def Create(self, request, global_params=None):
      r"""Creates a new Authentication in a given project and location.

      Args:
        request: (NetworksecurityProjectsLocationsAuthenticationCreateRequest) input message
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/authentication',
        http_method='POST',
        method_id='networksecurity.projects.locations.authentication.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['authenticationId'],
        relative_path='v1alpha1/{+parent}/authentication',
        request_field='authentication',
        request_type_name='NetworksecurityProjectsLocationsAuthenticationCreateRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Delete(self, request, global_params=None):
      r"""Deletes a single Authentication.

      Args:
        request: (NetworksecurityProjectsLocationsAuthenticationDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/authentication/{authenticationId}',
        http_method='DELETE',
        method_id='networksecurity.projects.locations.authentication.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}',
        request_field='',
        request_type_name='NetworksecurityProjectsLocationsAuthenticationDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Get(self, request, global_params=None):
      r"""Gets details of a single Authentication.

      Args:
        request: (NetworksecurityProjectsLocationsAuthenticationGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Authentication) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/authentication/{authenticationId}',
        http_method='GET',
        method_id='networksecurity.projects.locations.authentication.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}',
        request_field='',
        request_type_name='NetworksecurityProjectsLocationsAuthenticationGetRequest',
        response_type_name='Authentication',
        supports_download=False,
    )
    ...
    def GetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (NetworksecurityProjectsLocationsAuthenticationGetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/authentication/{authenticationId}:getIamPolicy',
        http_method='GET',
        method_id='networksecurity.projects.locations.authentication.getIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=['options_requestedPolicyVersion'],
        relative_path='v1alpha1/{+resource}:getIamPolicy',
        request_field='',
        request_type_name='NetworksecurityProjectsLocationsAuthenticationGetIamPolicyRequest',
        response_type_name='GoogleIamV1Policy',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""Lists Authentication in a given project and location.

      Args:
        request: (NetworksecurityProjectsLocationsAuthenticationListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListAuthenticationResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/authentication',
        http_method='GET',
        method_id='networksecurity.projects.locations.authentication.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1alpha1/{+parent}/authentication',
        request_field='',
        request_type_name='NetworksecurityProjectsLocationsAuthenticationListRequest',
        response_type_name='ListAuthenticationResponse',
        supports_download=False,
    )

    def Patch(self, request, global_params=None):
      r"""Updates the parameters of a single Authentication.

      Args:
        request: (NetworksecurityProjectsLocationsAuthenticationPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/authentication/{authenticationId}',
        http_method='PATCH',
        method_id='networksecurity.projects.locations.authentication.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['updateMask'],
        relative_path='v1alpha1/{+name}',
        request_field='authentication',
        request_type_name='NetworksecurityProjectsLocationsAuthenticationPatchRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def SetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (NetworksecurityProjectsLocationsAuthenticationSetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleIamV1Policy) The response message.
      """
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/authentication/{authenticationId}:setIamPolicy',
        http_method='POST',
        method_id='networksecurity.projects.locations.authentication.setIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha1/{+resource}:setIamPolicy',
        request_field='googleIamV1SetIamPolicyRequest',
        request_type_name='NetworksecurityProjectsLocationsAuthenticationSetIamPolicyRequest',
        response_type_name='GoogleIamV1Policy',
        supports_download=False,
    )
    ...
    def TestIamPermissions(self, request, global_params=None):
      ...
      Args:
        request: (NetworksecurityProjectsLocationsAuthenticationTestIamPermissionsRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/authentication/{authenticationId}:testIamPermissions',
        http_method='POST',
        method_id='networksecurity.projects.locations.authentication.testIamPermissions',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha1/{+resource}:testIamPermissions',
        request_field='googleIamV1TestIamPermissionsRequest',
        request_type_name='NetworksecurityProjectsLocationsAuthenticationTestIamPermissionsRequest',
