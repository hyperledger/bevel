...
class DomainAvailability(_messages.Message):
  ...
  class NoticesValueListEntryValuesEnum(_messages.Enum):
    ...
    Values:
      NOTICE_UNSPECIFIED: The notice is undefined.
      HSTS_PRELOADED: HSTS_PRELOADED indicates that the domain is preloaded on
        the HTTP Strict Transport Security list in browsers. Serving a website
        on such domain will require an SSL certificate. See
