...
spec:
  ...
  values:
    ...
    vault:
      ...
      rpcusersecretprefix: {{ component_vault.secret_path | default('secret') }}/data/{{ organization_data.name}}/{{ node.name }}/credentials
      keystoresecretprefix: {{ component_vault.secret_path | default('secret') }}/data/{{ organization_data.name}}/{{ node.name }}/credentials
      certsecretprefix: {{ component_vault.secret_path | default('secret') }}/data/{{ organization_data.name}}/{{ node.name }}/certs
    node:
