...
## Script Based Setup
You can use the [script](https://github.com/hyperledger-labs/blockchain-automation-framework/platforms/shared/scripts/dev_prerequisites_setup.bat) to setup developer prerequisites (currently for Windows OS only).   
