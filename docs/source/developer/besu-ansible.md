...
For Hyperledger Besu, the ansible roles nad playbooks are located at `/platforms/hyperledger-besu/configuration/`. Some of the common roles and playbooks between hyperledger-besu, Hyperledger-Indy, Hyperledger-Fabirc, Hyperledger-Besu and R3-Corda are located at `/platforms/shared/configurations/`
