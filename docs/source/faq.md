...
No, unfortunatley, the Blockchain Automation Framework currently only supports version 1.4.0 & 1.4.4 for Fabric and version 4.0 for Corda as minimum versions, and will only support future higher versions for Fabric and Corda.
