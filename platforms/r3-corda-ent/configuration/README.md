...
## Execution 
### Step 1
Ensure that the `network.yaml` is edited properly and saved. Follow the guidance on our [docs for R3 Corda `network.yaml`](https://bevel.readthedocs.io/en/latest/operations/corda_networkyaml.html), with extra annotations for R3 Corda Enterprise.
