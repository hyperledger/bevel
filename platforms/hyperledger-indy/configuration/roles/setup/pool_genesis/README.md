...
This role creates Helm releases of kubernetes Config Maps, which contain of generated pool genesis.
This role calls role from *create/helm_component/pool_genesis*
#### Input Variables:
