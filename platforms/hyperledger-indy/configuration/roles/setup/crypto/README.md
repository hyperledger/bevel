...
#### Input Variables:
This role doesn't use input variables on this place, please check role *create/imagepullsecret*, which input variables are used.
### 3. Create crypto of stewards, trustee and endorser
This role creates Helm releases of generator cryptos for stewards, trustee and endorser
This role calls role from *create/helm_component/crypto*
#### Input Variables:
...
This role checks for fill Vault of crypto data.
This role calls role *check/crypto*
#### Input Variables:
This role doesn't use input variables on this place, please check role *check/crypto*, which input variables are used. 