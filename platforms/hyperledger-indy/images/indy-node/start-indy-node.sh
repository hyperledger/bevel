...
chown indy:indy /var/lib/indy/keys /var/lib/indy/keys/$INDY_NETWORK_NAME /var/lib/indy/keys/$INDY_NETWORK_NAME/keys /var/lib/indy/keys/$INDY_NETWORK_NAME/keys/$INDY_NODE_NAME /var/lib/indy/keys/$INDY_NETWORK_NAME/keys/$INDY_NODE_NAME/public_keys /var/lib/indy/keys/$INDY_NETWORK_NAME/keys/$INDY_NODE_NAME/verif_keys
