...
**retries**:  It means this task will check whether the k8s resources is deployed or not for a maximum time of retries mentioned i.e 10. 
...
**retries**:  It means this task will check for the resources being deployed for a maximum time of retries mentioned i.e 10. 
**delay**:  It means each retry will happen at a gap of mentioned delay i.e 60 seconds.
