...
```
	sudo docker tag doorman:1.0 adopblockchaincloud0502.azurecr.io/doorman:doorman-linuxkit
	sudo docker push adopblockchaincloud0502.azurecr.io/doorman:doorman-linuxkit
```
