...
#### 9.  Check Ambassador cred exists for orderers
...
#### 10. Check if ca certs already created for orderers
...
#### 11. Check if ca key already created for orderers
...
#### 12.  Create the Ambassador credentials for orderers
