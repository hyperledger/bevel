...
jq --argjson a "$(cat ./orderer)" '.channel_group.groups.Orderer.values.ConsensusType.value.metadata.consenters += $a' {{ channel_name }}_config.json > {{ channel_name }}_modified_config.json
