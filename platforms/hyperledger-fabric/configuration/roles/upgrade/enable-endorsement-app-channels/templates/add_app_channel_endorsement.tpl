...
jq -s ".[0] * {\"channel_group\":{\"groups\":{\"Application\": {\"groups\": {\"{{ org_name }}\": {\"policies\": .[1].{{ org_name }}Policies}}}}}}" {{ channel_name }}_config_block.json ./enable_lifecycle_{{ org_name }}.json > modified_config.json
