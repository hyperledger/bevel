...
jq -s '.[0] * {"channel_group":{"groups":{"Application": {"values": {"ACLs": { "mod_policy": "Admins", "value": {"acls": .[1].acls}}}}}}}' {{ channel_name }}_config_block.json ./add_app_channel_acls.json > modified_config.json
