...
spec:
  ...
  values:
    ...
    vault:
      ...
      adminsecretprefix: {{ vault.secret_path | default('secret') }}/data/crypto/peerOrganizations/{{ component_ns }}/users/admin
      orderersecretprefix: {{ vault.secret_path | default('secret') }}/data/crypto/peerOrganizations/{{ component_ns }}/orderer 
