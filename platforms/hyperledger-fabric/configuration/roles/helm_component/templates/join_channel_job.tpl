...
{% endif %}
    ...
    vault:
      ...
      adminsecretprefix: {{ vault.secret_path | default('secretsv2') }}/data/crypto/{{ component }}/users/admin
      orderersecretprefix: {{ vault.secret_path | default('secretsv2') }}/data/crypto/{{ component }}/orderer
