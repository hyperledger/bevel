...
## ROLE: create/crypto/qbft
This role generates qbftConfigFile.json, key, key.pub, genesis.json and nodeAddress for each organization.
### main.yaml
### Tasks
...
#### 10. Create qbftConfigFile.json
This task creates the qbftConfigFile.json using the qbftConfigFile.tpl file in templates .
##### Input Variables
...
#### 11. Generate crypto for QBFT consensus
 This task generates the key, key.pub and genesis file for qbft consensus
